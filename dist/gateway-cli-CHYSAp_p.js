...
import { B as theme, D as isPlainObject, E as truncateUtf16Safe, H as getLogger, P as setVerbose, R as colorize, S as shortenHomePath, U as getResolvedLoggerSettings, V as getChildLogger, c as ensureDir, r as clamp, y as resolveUserPath, z as isRich } from "./utils-DNXtLoeA.js";
...
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-DrVRn_Jz.js";
import { Ht as isPidAlive, Qt as DEFAULT_PROVIDER, Wt as normalizeSecretInput, Xt as DEFAULT_CONTEXT_TOKENS, Zt as DEFAULT_MODEL, a as getModelRefStatus, f as resolveAllowedModelRef, g as resolveHooksGmailModel, h as resolveDefaultModelForAgent, m as resolveConfiguredModelRef, s as isCliProvider, t as buildAllowedModelSet, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection } from "./model-selection-BplWstrh.js";
import "./github-copilot-token-nncItI8D.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import "./boolean-BgXe2hyu.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-C-qlQMcy.js";
import "./host-env-security-ljCLeQmh.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-CNKATuOe.js";
import "./send-DC_gnWl7.js";
import { A as isAvatarImageDataUrl, At as resolveAgentMaxConcurrent, D as AVATAR_MAX_BYTES, E as parseByteSize, Ot as buildTalkConfigResponse, P as looksLikeAvatarPath, T as parseDurationMs, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as OpenClawSchema, i as loadConfig, jt as resolveSubagentMaxConcurrent, k as isAvatarHttpUrl, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins, vt as applyMergePatch, yt as applyLegacyMigrations } from "./config-B-zigsOM.js";
...
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-DmfPU4rc.js";
import "./dock-pv6HNE8P.js";
import { d as registerUnhandledRejectionHandler } from "./runner-DlkDtGMF.js";
import { x as extractTextFromChatContent } from "./image-BnuhI2Cj.js";
import "./models-config-Cyvd_XlY.js";
import "./pi-model-discovery-Bakt-Qrp.js";
import "./pi-embedded-helpers-CYkXMKVk.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-Cj9__aI8.js";
...
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-BSqgz1Js.js";
...
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-BD8Ix8PK.js";
import { c as ensureGatewayStartupAuth, l as mergeGatewayTailscaleConfig } from "./server-context-Cur9z9vt.js";
import { d as hasBinary } from "./frontmatter-DR47FZL2.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-CCMjt8qH.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-CejwTirm.js";
import { i as compileSafeRegex } from "./redact-CsoNhWtr.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-Fe4Am7dY.js";
import { i as sameFileIdentity, n as openFileWithinRoot, r as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-DwCRJYoe.js";
import "./paths-BXdAEtPH.js";
import { t as SsrFBlockedError } from "./ssrf-D0C-ivqd.js";
import { c as detectMime } from "./image-ops-CE-faKvL.js";
import "./store-BK1dfn-n.js";
import { a as inspectPortUsage, c as formatPortDiagnostics, r as ensurePortAvailable } from "./ports-3dBfxsrO.js";
import { t as movePathToTrash } from "./trash-D8z5X58K.js";
import "./server-middleware-BrDs7VpV.js";
import { $ as resolveMainSessionKeyFromConfig, A as readSessionMessages, D as archiveSessionTranscripts, E as archiveFileOnDisk, F as stripEnvelopeFromMessages, J as setSessionRuntimeModel, L as stripInlineDirectiveTagsForDisplay, N as resolveSessionTranscriptCandidates, O as capArrayByJsonBytes, P as stripEnvelopeFromMessage, Q as resolveMainSessionKey, R as stripInlineDirectiveTagsFromMessageForDisplay, S as mergeDeliveryContext, U as resolveSessionResetPolicy, V as evaluateSessionFreshness, X as resolveAgentMainSessionKey, Y as canonicalizeMainSessionAlias, Z as resolveExplicitAgentSessionKey, b as deliveryContextFromSession, c as loadSessionStore, h as updateSessionStore, j as readSessionPreviewItemsFromTranscript, k as cleanupArchivedSessionTranscripts, n as extractDeliveryInfo, r as parseSessionThreadInfo, st as cleanStaleLockFiles, tt as snapshotSessionOrigin, w as normalizeSessionDeliveryFields } from "./sessions-DqsLePIP.js";
import { n as listChannelPlugins, o as normalizeWhatsAppTarget, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BinSBKMc.js";
import { i as resolveWhatsAppAccount } from "./accounts-dnbnpwVy.js";
import "./accounts-v9OZODSg.js";
import "./accounts-CRMme1-m.js";
import { t as buildChannelAccountBindings } from "./bindings-ClBJqDjo.js";
import "./logging-6RmrnEvA.js";
import "./send-B_0OrRns.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DlJnj-kN.js";
...
import { a as ToolInputError } from "./target-errors-CYwiezmi.js";
import "./diagnostic-session-state-SaJqT4ri.js";
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-B1gAmQeQ.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-RiNhxqE9.js";
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-B-QL3Maf.js";
import "./model-7KBHDDZc.js";
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-5xu-ppj6.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-DXxJ98UL.js";
import { n as resolveMemorySearchConfig } from "./manager-U4h8roY4.js";
...
import { t as getChannelActivity } from "./channel-activity-GY5H5R7T.js";
...
import { n as withProgress } from "./progress-D9e-_5R1.js";
import "./resolve-route-DcNxLgKf.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-Y3MzHcBa.js";
import "./replies-DVonfCs7.js";
import { S as registerSkillsChangeListener, _ as requestNodePairing, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, x as getSkillsSnapshotVersion, y as verifyNodeToken } from "./skill-commands-C8lbexww.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-C_qqC6-T.js";
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-fSLOH4tB.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CzvWLasv.js";
import "./outbound-attachment-Bx4qvyPz.js";
import "./delivery-queue-CUHuw1Sc.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-uoPEmNk1.js";
import "./send-C5tDSWnl.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-BWT9XK6x.js";
import "./prompt-style-D3Nh-ono.js";
import "./pairing-labels-BnyqFGCm.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-DPJ95vAT.js";
import "./server-lifecycle-xThr9fdy.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CPIlBwxt.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-crZ7PtB0.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Cpr71MF0.js";
import "./runtime-guard-DSWGxN2k.js";
import { t as forceFreePortAndWait } from "./ports-CxnecODK.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-A3zgAUwz.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-kzSsYCW7.js";
import { n as inheritOptionFromParent } from "./command-options-CFt-BH8r.js";
import { t as WizardCancelledError } from "./prompts-BQGxx-rv.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-eFH5JfYx.js";
import { t as isWithinDir } from "./path-safety-DmmdsCKG.js";
import "./install-safe-path-CrkvjGX6.js";
import "./skill-scanner-uH2tYPYy.js";
import { t as buildChannelAccountSnapshot } from "./status-qNLbAXPm.js";
import "./channels-status-issues-CVhl74Vc.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-C7arBViP.js";
import "./daemon-install-helpers-CHb1f0qx.js";
import "./systemd-xGWqaz9t.js";
import "./service-DNj2-Nul.js";
import "./lifecycle-core-BdcdYshg.js";
import "./systemd-hints-B1iDZOoT.js";
import { t as parsePort$1 } from "./parse-port-BeoMTegh.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-u5zyP90L.js";
import "./diagnostics-m_uMN2mh.js";
import "./table-j0gwTG09.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-BTwlYld3.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-Cwxfcq1z.js";
import { c as resolveNodeCommandAllowlist, l as probeGateway, n as collectEnabledInsecureOrDangerousFlags, s as isNodeCommandAllowed } from "./audit-DH21-ivO.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-7DpRiyJs.js";
import { n as getStatusSummary, r as pickGatewaySelfPresence } from "./status-BDN18QIF.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BfYdRHB3.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-mmx2V6g4.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-D457fxxi.js";
import { t as runOnboardingWizard } from "./onboarding-D1Z0BI9X.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-_G_ZWpbv.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-gMf_7KHW.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-GxsPYTzE.js";
import "./node-service-BJWwMmzW.js";
import "./status.update-ByI32EQ6.js";
import { t as resolveSystemRunCommand } from "./system-run-command-DjU0azgh.js";
import { t as installSkill } from "./skills-install-C7bEgQS8.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-icIFZAoO.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-DbAyijeL.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DA5yPqQQ.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-uoPEmNk1.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-CB57uGcb.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-CUHuw1Sc.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-CdP4kAhm.js").then((n) => n.n);
