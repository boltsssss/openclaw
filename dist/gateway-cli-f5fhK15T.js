...
import { u as isTestDefaultMemorySlotDisabled } from "./manifest-registry-BVdb5-Ch.js";
...
import { $n as runEmbeddedPiAgent, Ar as resolveTtsPrefsPath, C as resolveAgentDeliveryPlan, Cn as extractFileContentFromSource, Cr as clearBootstrapSnapshotOnSessionRollover, Ct as normalizeOptionalSessionKey, D as createOutboundSendDeps$1, Dr as resolveTtsApiKey, Dt as migrateLegacyCronPayload, E as createDefaultDeps, En as resolveInputFileLimits, Er as isTtsProviderConfigured, Et as normalizeRequiredName, F as createReplyPrefixOptions, Fr as OPENAI_TTS_MODELS, Ft as closeTrackedBrowserTabsForSessions, G as createReplyDispatcher, Gr as waitForActiveTasks, Gt as parseVerboseOverride, Hr as markGatewayDraining, I as buildHistoryContextFromEntries, In as countActiveDescendantRuns, Ir as OPENAI_TTS_VOICES, It as applyBrowserProxyPaths, J as buildBareSessionResetPrompt, Jn as resolveAnnounceTargetFromKey, Jt as unbindThreadBindingsBySessionKey, K as getTotalPendingReplies, Kn as resolveAgentTimeoutMs, Kr as CommandLane, Kt as normalizeSpawnedRunMetadata, Lt as persistBrowserProxyFiles, Mn as isAbortRequestText, Mr as setTtsEnabled, Mt as detectSuspiciousPatterns, Nn as stopSubagentsForRequester, Nr as setTtsProvider, Nt as getHookType, On as normalizeSendPolicy, Or as resolveTtsAutoMode, Ot as normalizeLegacyDeliveryInput, Pr as textToSpeech, Pt as isExternalHookSession, Q as createOpenClawTools, Qn as buildOutboundSessionContext, Rr as enqueueCommandInLane, Rt as resolveSessionAuthProfileOverride, Sn as DEFAULT_INPUT_TIMEOUT_MS, Sr as clearBootstrapSnapshot, St as normalizeOptionalAgentId, T as createOutboundSendDeps, Tn as normalizeMimeList, Tr as isTtsEnabled, Tt as normalizePayloadToSystemText, Ur as resetAllLanes, Ut as applyModelOverrideToSessionEntry, Vn as listDescendantRunsForRequester, Vr as getTotalQueueSize, W as dispatchInboundMessage, Wr as setCommandLaneConcurrency, Wt as applyVerboseOverride, X as setCliSessionId, Y as getCliSessionId, Yn as readLatestAssistantReply, Yr as stripHeartbeatToken, Yt as normalizeGroupActivation, Z as runCliAgent, Zn as clearSessionQueues, Zt as loadProviderUsageSummary, _ as requestBodyErrorToText, _t as writeRestartSentinel, a as getPluginToolMeta, ar as clearAgentRunContext, at as resolveSessionDeliveryTarget, bn as DEFAULT_INPUT_IMAGE_MAX_BYTES, br as resolveUserTimezone, bt as normalizeCronJobPatch, c as loadOpenClawPlugins, cr as onAgentEvent, ct as resetDirectoryCache, dt as consumeRestartSentinel, er as abortEmbeddedPiRun, et as ensureOutboundSessionEntry, fr as resolveBootstrapWarningSignaturesSeen, ft as formatDoctorNonInteractiveHint, g as readJsonBodyWithLimit, gr as resolveAgentIdentity, h as handleSlackHttpRequest, hr as resolveAgentSessionDirs, ht as summarizeRestartSentinel, ir as resolveCronStyleNow, it as resolveOutboundTarget, j as resolveAgentAvatar, jr as resolveTtsProviderOrder, jt as buildSafeExternalPrompt, kn as resolveSendPolicy, kr as resolveTtsConfig, l as createPluginRuntime, ln as enqueueSystemEvent, lr as registerAgentRunContext, mr as getAcpSessionManager, n as applyToolPolicyPipeline, nr as waitForEmbeddedPiRunEnd, o as resolvePluginTools, or as emitAgentEvent, ot as resolveOutboundChannelPlugin, p as resolveAgentOutboundIdentity, pn as requestHeartbeatNow, pt as formatRestartSentinelMessage, qn as runSubagentAnnounceFlow, qt as resolveIngressWorkspaceOverrideForSpawnedRun, r as buildDefaultToolPolicyPipelineSteps, sr as getAgentRunContext, tn as formatZonedTimestamp, tr as getActiveEmbeddedRunCount, tt as resolveOutboundSessionRoute, un as isSystemEventContextChanged, ut as runWithModelFallback, vt as normalizeHttpWebhookUrl, w as resolveAgentOutboundTarget, wn as extractImageContentFromSource, wr as getTtsProvider, wt as normalizeOptionalText, x as agentCommandFromIngress, xn as DEFAULT_INPUT_IMAGE_MIMES, xt as inferLegacyName, yt as normalizeCronJobCreate, zn as initSubagentRegistry, zr as getActiveTaskCount } from "./compact-DMF7sYYq.js";
...
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-DL0WZs9n.js";
import { j as runGlobalGatewayStopSafely, k as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-rw1tPUf_.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, h as isDiagnosticsEnabled } from "./diagnostic-DiZeKwAs.js";
import "./accounts-Dd357WkV.js";
import { c as detectMime } from "./image-ops-BZX4S9OA.js";
import { b as resolveCronStorePath, x as saveCronStore, y as loadCronStore } from "./send-Dq8eCEpI.js";
...
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-CXOln2Tp.js";
...
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-B0Tbje2W.js";
import { c as normalizeHostHeader, d as resolveGatewayBindHost, f as resolveGatewayListenHosts, i as isLoopbackHost, l as pickPrimaryLanIPv4, n as isLocalishHost, o as isTrustedProxyAddress, r as isLoopbackAddress, s as isValidIPv4, t as rawDataToString, u as resolveClientIp } from "./ws-Crq-SBzZ.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-BiSssJvb.js";
import { a as readGatewayPasswordEnv, o as readGatewayTokenEnv } from "./credentials-CG1_itLT.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-DxJfVAjE.js";
import { d as mergeGatewayTailscaleConfig, l as ensureGatewayStartupAuth, u as mergeGatewayAuthConfig } from "./server-context-DiqjK5CC.js";
...
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-Bjq6BP04.js";
import "./paths-Bv0Fd5hm.js";
import { n as SsrFBlockedError } from "./proxy-env-ClgEcKHf.js";
...
import { i as normalizeInputProvenance } from "./input-provenance-D3NyQiFj.js";
...
import { n as loadModelCatalog } from "./model-catalog-BBj8P1yA.js";
import "./fetch-BotRHV64.js";
import { v as registerUnhandledRejectionHandler } from "./audio-transcription-runner-CjHzhZEE.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BArX2uTC.js";
import { b as extractTextFromChatContent } from "./image-BmU4F15L.js";
...
import { h as resolveSystemRunApprovalRuntimeContext, m as resolveSystemRunApprovalRequestContext } from "./nodes-screen-COQYcLH6.js";
...
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-Mk5yRUO5.js";
...
import { n as GATEWAY_AUTH_SURFACE_PATHS, p as isKnownSecretTargetId, r as evaluateGatewayAuthSurfaceStates } from "./runtime-config-collectors-B4YgJqco.js";
import "./command-secret-targets-DC8aFOgw.js";
import "./connection-auth-Cq9z9CRa.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-4FpJjucI.js";
import "./prompt-style-DMLxb9pN.js";
import "./pairing-labels-C1LHlXdZ.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-Bwv7gASm.js";
import { i as resolveMemorySearchConfig } from "./manager-DyxNW1fm.js";
...
import { t as buildWorkspaceSkillStatus } from "./skills-status-DYkJpUSj.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-B8j-Eqzy.js";
import { t as isWithinDir } from "./path-safety-D9zc0rNm.js";
import "./install-safe-path-DLZIuTKk.js";
import "./skill-scanner-CB0FoAsR.js";
import { n as formatConfigIssueLines } from "./issue-format-D_VB3OXI.js";
import { t as buildChannelAccountSnapshot } from "./status-w2KoAh0g.js";
import "./channels-status-issues-CpfvpmtK.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-AGU2Zs-f.js";
import "./daemon-install-plan.shared-D5f-djeh.js";
import "./runtime-guard-qGANlyDE.js";
import "./gateway-install-token-CaW0zYte.js";
import "./systemd-CKDkXL0B.js";
import "./service-WG9QD4EX.js";
import "./lifecycle-core-Bep8Cpvm.js";
import "./systemd-hints-a3WA4N31.js";
import { t as parsePort$1 } from "./parse-port-BhmBKEXL.js";
import { c as parseProcCmdline, n as addGatewayServiceCommands, s as isGatewayArgv } from "./daemon-cli-6aCX22u3.js";
import { r as probeGateway } from "./probe-auth-CxLlBMKq.js";
import "./diagnostics-CmAB8p8W.js";
...
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-jARwJpwW.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DC2uq4Kg.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-CkEhd6Vu.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-eaejWZIt.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BwNXib05.js";
...
import { a as resolveCommandSecretsFromActiveRuntimeSnapshot, i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-BgOC4cXK.js";
import "./onboarding.secret-input-RmTBUY2_.js";
import { t as runOnboardingWizard } from "./onboarding-C0bmo_CZ.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-C1hLG4xP.js";
...
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-BrLwh9Fk.js";
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-BiRDt0bA.js";
import "./node-service-vN7goxnE.js";
import "./status.update-Ck36Zdaf.js";
import { t as installSkill } from "./skills-install-BM9Gk40l.js";
import { t as runGatewayUpdate } from "./update-runner-BwzM70Nz.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C2zUIVmE.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-DP6-F6If.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-rw1tPUf_.js").then((n) => n.n);
