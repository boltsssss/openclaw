...
import { T as parseDurationMs, i as loadConfig, mt as splitShellArgs } from "./config-RlRKjsmM.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-BEs7YpS_.js";
import { t as formatDocsLink } from "./links-DfYXF6CQ.js";
import { r as withManager } from "./cli-utils-B_gcZWk3.js";
import { t as formatHelpExamples } from "./help-format-Yb22e8jt.js";
import { n as withProgress, r as withProgressTotals } from "./progress-DGbpXOaw.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-C0JotFGf.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-BA1uW-Hu.js").then((n) => n.t);
