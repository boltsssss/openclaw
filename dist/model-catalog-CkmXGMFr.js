...
import { E as resolveOpenClawAgentDir } from "./auth-profiles-VHiPC1-T.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-DR4Y76aa.js").then((n) => n.n)).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
