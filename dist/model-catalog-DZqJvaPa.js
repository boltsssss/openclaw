...
import { zt as resolveOpenClawAgentDir } from "./model-selection-BplWstrh.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-Cs-NiTy3.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
