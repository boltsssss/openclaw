...
import { $n as runEmbeddedPiAgent, $t as formatUsageWindowSummary, Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Lr as resolveModelWithRegistry, Vt as buildAuthHealthSummary, Zt as loadProviderUsageSummary, en as resolveUsageProviderId, pr as describeFailoverError, zt as maskApiKey } from "./compact-DMF7sYYq.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-cRvT43YX.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-DC8aFOgw.js";
import { f as openUrl } from "./onboard-helpers-4FpJjucI.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-BJh-Dltk.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-DuXi49Pv.js";
import { n as logConfigUpdated } from "./logging-BKVAdTiF.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-Cke_SlgQ.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-NErpMNir.js").then((n) => n.t);
	const { ensureOpenClawModelsJson } = await import("./models-config-B9AkMhND.js").then((n) => n.n);
