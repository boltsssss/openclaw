...
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-DhI_kPU3.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-DR4Y76aa.js";
import { r as resolveForwardCompatModel } from "./model-CbAr_Ite.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CwESh4K1.js";
import { T as parseDurationMs, i as loadConfig } from "./config-RlRKjsmM.js";
import { $t as formatRemainingShort, Qt as buildAuthHealthSummary, Xt as maskApiKey, Zt as DEFAULT_OAUTH_WARN_MS, _n as resolveUsageProviderId, bt as describeFailoverError, gn as formatUsageWindowSummary, mn as loadProviderUsageSummary, s as runEmbeddedPiAgent } from "./subagent-registry-l8AgTmVw.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DDT5WL2f.js";
import { t as ensureOpenClawModelsJson } from "./models-config-YyIHvK1l.js";
import { n as loadModelCatalog } from "./model-catalog-CkmXGMFr.js";
import { r as withProgressTotals } from "./progress-DGbpXOaw.js";
import { f as openUrl } from "./onboard-helpers-fbWwDD_g.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-C6kg3YRh.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-DOJTtE9J.js";
import { n as logConfigUpdated } from "./logging-D-v2TQby.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-DdFNbsfg.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore } = await import("./auth-profiles-VHiPC1-T.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CbAr_Ite.js").then((n) => n.t);
