...
import { T as parseDurationMs, i as loadConfig } from "./config-B-zigsOM.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-Cyvd_XlY.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DlJnj-kN.js";
...
import { r as resolveForwardCompatModel } from "./model-7KBHDDZc.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./model-CtNRxH7h.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-DK6017OO.js";
import "./help-format-UE3NC3_c.js";
import { r as withProgressTotals } from "./progress-D9e-_5R1.js";
...
import { f as openUrl } from "./onboard-helpers-BWT9XK6x.js";
...
import { t as createClackPrompter } from "./clack-prompter-BcHdOOBi.js";
import { t as renderTable } from "./table-j0gwTG09.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BANpe8u3.js";
import { n as redactSecrets } from "./format-CC64GBBn.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-9VjVIcCf.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-1ZllPEmU.js";
import { n as logConfigUpdated } from "./logging-Dz3gvmEl.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-BDDMGTJZ.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-B-zigsOM.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-BplWstrh.js").then((n) => n.mt);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CtNRxH7h.js");
