...
import { Ct as runEmbeddedPiAgent, Gt as formatUsageWindowSummary, Kt as resolveUsageProviderId, Ut as loadProviderUsageSummary, Vr as resolveModelWithRegistry, a as buildAuthHealthSummary, i as DEFAULT_OAUTH_WARN_MS, o as formatRemainingShort, r as maskApiKey, wn as describeFailoverError } from "./reply-BNraYLOV.js";
...
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-kQZAx6rB.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-A0mDXQMJ.js";
import "./connection-auth-CJHUONGh.js";
import { f as openUrl } from "./onboard-helpers-DY47xnlF.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-CeXo_sGt.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-D1a3Xcwz.js";
import { n as logConfigUpdated } from "./logging-nwXfrc4H.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, l as githubCopilotLoginCommand, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-D5F8SR5n.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-BoktjT0J.js").then((n) => n.gt);
	const { ensureOpenClawModelsJson } = await import("./models-config-Dyo8WfaT.js").then((n) => n.n);
