...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-BI_9bRVk.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-B-zigsOM.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BWT9XK6x.js";
...
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-D3e11yMG.js";
import { t as runOnboardingWizard } from "./onboarding-D1Z0BI9X.js";
import { n as logConfigUpdated } from "./logging-Dz3gvmEl.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-CkINuKRw.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CmVQ38Re.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-MeYc2i9a.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Ct7mwLfT.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BfYdRHB3.js").then((n) => n.i);
