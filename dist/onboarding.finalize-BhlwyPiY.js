...
import { p as restoreTerminalState } from "./subsystem-4K-e3L3i.js";
import { h as pathExists, y as resolveUserPath } from "./utils-BhZbo8Nw.js";
import "./thinking-BYwvlJ3S.js";
import "./reply-BNraYLOV.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-CZF6h_5g.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-DY47xnlF.js";
...
import { t as runTui } from "./tui-DDjlD4Zs.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CBBm7axF.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BRFISzd6.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BRFISzd6.js");
