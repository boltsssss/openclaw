import { p as restoreTerminalState } from "./subsystem-kzdGVyce.js";
...
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-BDXYqF89.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-4FpJjucI.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BwNXib05.js";
import { t as resolveOnboardingSecretInputString } from "./onboarding.secret-input-RmTBUY2_.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-B3024S1v.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-hlxzxPQ0.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-hlxzxPQ0.js");
