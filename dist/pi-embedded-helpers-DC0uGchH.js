import { D as runExec, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-CpuaD-NT.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-BY8fKpqm.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-CtFhasYm.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-YGVrIVO5.js";
import { n as parseBooleanValue, r as formatCliCommand } from "./env-DJfFMKsc.js";
import { t as generateSecureToken } from "./secure-random-D7Pne8Yn.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-A6CwyuOb.js";
import { _ as getBlockedNetworkModeReason, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-BZiY63-i.js";
import { A as resolveWritablePathWithinRoot, B as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as stopChromeExtensionRelayServer, D as DEFAULT_UPLOAD_DIR, E as DEFAULT_TRACE_DIR, F as DEFAULT_AI_SNAPSHOT_MAX_CHARS, I as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, L as DEFAULT_BROWSER_EVALUATE_ENABLED, N as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, O as resolveExistingPathsWithinRoot, P as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, R as DEFAULT_OPENCLAW_BROWSER_COLOR, S as ensureChromeExtensionRelayServer, T as DEFAULT_DOWNLOAD_DIR, _ as appendCdpPath, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, i as launchOpenClawChrome, j as isLoopbackHost, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchJson, y as fetchOk, z as DEFAULT_OPENCLAW_BROWSER_ENABLED } from "./chrome-DjysP1au.js";
import { t as SsrFBlockedError } from "./ssrf-B7akL5oa.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-JylHWoG1.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-B5JHXmzV.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-BHB7ejqQ.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-ccwKyrcv.js";
import { B as canonicalizeMainSessionAlias, K as acquireSessionWriteLock, V as resolveAgentMainSessionKey } from "./sessions-Cdgl70YA.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-C-7MSLOm.js";
import { o as normalizeThinkLevel } from "./thinking-D7pOfoaj.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-C0C8zojr.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-C0C8zojr.js")).closePlaywrightBrowserConnection();
		} catch {}
