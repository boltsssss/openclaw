...
import { t as sanitizeContentBlocksImages } from "./tool-images-CLsBSEaw.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DNaEIYaL.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-DNaEIYaL.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
