import { d as resolveSessionAgentId, r as resolveAgentConfig } from "./agent-scope-D1xpYq3C.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-C9do7WCN.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-CrwwXlyy.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-YGVrIVO5.js";
import { _ as runExec, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-BM04KBG8.js";
import { n as formatCliCommand } from "./env-MQSDvtCV.js";
import { t as parseBooleanValue } from "./boolean-mcn6kL0s.js";
import { t as generateSecureToken } from "./secure-random-faWesvBQ.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-CKXPj7Vf.js";
import { _ as getBlockedNetworkModeReason, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-Bi0kYY78.js";
import { A as resolveWritablePathWithinRoot, B as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as stopChromeExtensionRelayServer, D as DEFAULT_UPLOAD_DIR, E as DEFAULT_TRACE_DIR, F as DEFAULT_AI_SNAPSHOT_MAX_CHARS, I as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, L as DEFAULT_BROWSER_EVALUATE_ENABLED, N as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, O as resolveExistingPathsWithinRoot, P as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, R as DEFAULT_OPENCLAW_BROWSER_COLOR, S as ensureChromeExtensionRelayServer, T as DEFAULT_DOWNLOAD_DIR, _ as appendCdpPath, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, i as launchOpenClawChrome, j as isLoopbackHost, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchJson, y as fetchOk, z as DEFAULT_OPENCLAW_BROWSER_ENABLED } from "./chrome-DYZuAy1o.js";
import { t as SsrFBlockedError } from "./ssrf-BnuIFCPj.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-O9pUKXC8.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-5uqoMz3B.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-CHzQ0NP_.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-bxzQO4uA.js";
import { B as resolveAgentMainSessionKey, G as acquireSessionWriteLock, z as canonicalizeMainSessionAlias } from "./sessions-CL_qzDAQ.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BOtF6qA2.js";
import { o as normalizeThinkLevel } from "./thinking-6RspTgk5.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-C3Z6Aio1.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-C3Z6Aio1.js")).closePlaywrightBrowserConnection();
		} catch {}
