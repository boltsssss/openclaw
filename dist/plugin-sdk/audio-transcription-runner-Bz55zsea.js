import { J as resolveAgentModelPrimaryValue, O as runExec, q as resolveAgentModelFallbackValues } from "./run-with-concurrency-BYcjD-0M.js";
import { y as normalizeChatType } from "./plugins-jSjFnM3N.js";
import { E as loadConfig, I as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, L as isInboundPathAllowed, R as mergeInboundPathRoots, ar as normalizeProviderId, fr as normalizeGoogleModelId, i as resolveApiKeyForProvider, qn as resolveOpenClawAgentDir, r as requireApiKey, z as resolveIMessageAttachmentRoots } from "./model-auth-BvYANZOW.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./logger-empOIykk.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CwzGLhFo.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-BNZjsByj.js";
...
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DhwA57LJ.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-Bkb0aJO3.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-BLWSg-QW.js").then((n) => n.r);
