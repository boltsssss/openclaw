import { O as runExec, U as resolveAgentModelFallbackValues, W as resolveAgentModelPrimaryValue } from "./run-with-concurrency-Cbd-bzCk.js";
import { Gt as normalizeProviderId, Qt as normalizeGoogleModelId, Rn as resolveOpenClawAgentDir, _ as mergeInboundPathRoots, g as isInboundPathAllowed, h as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, i as loadConfig, in as resolveApiKeyForProvider, rn as requireApiKey, v as resolveIMessageAttachmentRoots } from "./config-CkXQYijU.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./logger-Blr-bUxJ.js";
import { x as normalizeChatType } from "./plugins-BIEkvWNb.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-C8XCXp_u.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-Dk8UycEG.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DyWLB2kT.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-NsqkTcAp.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BSux75Ln.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-By91ZM28.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-CeRC7OhU.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DexsAtrL.js").then((n) => n.r);
