import { R as isNotFoundPathError, z as isPathInside } from "./run-with-concurrency-BYcjD-0M.js";
import { Dr as normalizeSecretInputString, E as loadConfig, Or as resolveSecretInputRef, Q as secretRefKey, ct as isLoopbackIpAddress, lt as isPrivateOrLoopbackIpAddress, ut as normalizeIpAddress, v as resolveSecretRefValues } from "./model-auth-BvYANZOW.js";
import { O as createSubsystemLogger, X as resolvePreferredOpenClawTmpDir, a as CONFIG_DIR } from "./logger-empOIykk.js";
import { n as SsrFBlockedError, o as isPrivateNetworkAllowedByPolicy, s as resolvePinnedHostnameWithPolicy, t as hasProxyEnvConfigured } from "./proxy-env-mNaqKy65.js";
import { a as isErrno } from "./errors-Da_66i-s.js";
import { i as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-DyFQQ6Zh.js";
...
//#endregion
export { DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as $, resolveExistingPathsWithinRoot as A, BrowserTargetAmbiguousError as B, PROFILE_ATTACH_RETRY_TIMEOUT_MS as C, DEFAULT_DOWNLOAD_DIR as D, rawDataToString as E, BrowserProfileNotFoundError as F, assertBrowserNavigationResultAllowed as G, toBrowserErrorResponse as H, BrowserProfileUnavailableError as I, normalizeBrowserFormField as J, withBrowserNavigationPolicy as K, BrowserResetUnsupportedError as L, resolveWritablePathWithinRoot as M, BrowserConfigurationError as N, DEFAULT_TRACE_DIR as O, BrowserConflictError as P, DEFAULT_AI_SNAPSHOT_MAX_CHARS as Q, BrowserResourceExhaustedError as R, CDP_JSON_NEW_TIMEOUT_MS as S, withNoProxyForCdpUrl as T, InvalidBrowserNavigationUrlError as U, BrowserValidationError as V, assertBrowserNavigationAllowed as W, isSecureWebSocketUrl as X, isLoopbackHost as Y, DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS as Z, getHeadersWithAuth as _, resolveOpenClawUserDataDir as a, ensureChromeExtensionRelayServer as b, resolveBrowserExecutableForPlatform as c, formatAriaSnapshot as d, DEFAULT_OPENCLAW_BROWSER_COLOR as et, normalizeCdpWsUrl as f, fetchOk as g, fetchJson as h, launchOpenClawChrome as i, resolveStrictExistingPathsWithinRoot as j, DEFAULT_UPLOAD_DIR as k, captureScreenshot as l, appendCdpPath as m, isChromeCdpReady as n, stopOpenClawChrome as o, snapshotAria as p, DEFAULT_FILL_FIELD_TYPE as q, isChromeReachable as r, resolveLsofCommandSync as s, getChromeWebSocketUrl as t, DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as tt, createTargetViaCdp as u, normalizeCdpHttpBaseForJsonEndpoints as v, resolveCdpReachabilityTimeouts as w, stopChromeExtensionRelayServer as x, withCdpSocket as y, BrowserTabNotFoundError as z };
