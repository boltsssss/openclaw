...
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-CFfib1bc.js";
...
function startDiagnosticHeartbeat() {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-dJ6mp9FS.js").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
