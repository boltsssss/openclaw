...
const defaultImportPiSdk = () => import("./pi-model-discovery-DTJUIfbi.js");
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-DTJUIfbi.js");
			const agentDir = resolveOpenClawAgentDir();
