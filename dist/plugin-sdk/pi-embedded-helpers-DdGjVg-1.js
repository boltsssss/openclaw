import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, W as normalizeHyphenSlug, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency--DqJaNfK.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-BwvikR5p.js";
import { $n as isPidAlive, Bn as containsEnvVarReference, D as loadConfig, Dr as hasConfiguredSecretInput, M as writeConfigFile, Qn as getProcessStartTime, Ur as parseBooleanValue, Wr as formatCliCommand, Zn as resolveProcessScopedMap, et as secretRefKey, jr as resolveSecretInputRef, jt as CHANNEL_IDS, nt as parseDurationMs, rt as parseByteSize, tt as getBlockedNetworkModeReason, v as resolveSecretRefValues, w as createConfigIO } from "./model-auth-DMzDFWSO.js";
import { E as truncateUtf16Safe, M as defaultRuntime, O as createSubsystemLogger, h as normalizeE164, y as resolveUserPath } from "./logger-empOIykk.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-CyBu6eBm.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-C42Kbei8.js";
import { t as SsrFBlockedError } from "./ssrf-CJV99J3t.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-CPqtW_nx.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-DgWlKl_4.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-gYGRyOVw.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-EfXQPW7F.js";
import { A as resolveExistingPathsWithinRoot, B as BrowserTargetAmbiguousError, D as DEFAULT_DOWNLOAD_DIR, F as BrowserProfileNotFoundError, G as assertBrowserNavigationResultAllowed, H as toBrowserErrorResponse, I as BrowserProfileUnavailableError, J as normalizeBrowserFormField, K as withBrowserNavigationPolicy, L as BrowserResetUnsupportedError, M as resolveWritablePathWithinRoot, N as BrowserConfigurationError, O as DEFAULT_TRACE_DIR, P as BrowserConflictError, Q as DEFAULT_AI_SNAPSHOT_MAX_CHARS, R as BrowserResourceExhaustedError, S as CDP_JSON_NEW_TIMEOUT_MS, U as InvalidBrowserNavigationUrlError, V as BrowserValidationError, W as assertBrowserNavigationAllowed, Y as isLoopbackHost, Z as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, a as resolveOpenClawUserDataDir, b as ensureChromeExtensionRelayServer, c as resolveBrowserExecutableForPlatform, et as DEFAULT_OPENCLAW_BROWSER_COLOR, f as normalizeCdpWsUrl, g as fetchOk, h as fetchJson, i as launchOpenClawChrome, k as DEFAULT_UPLOAD_DIR, l as captureScreenshot, m as appendCdpPath, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, tt as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as createTargetViaCdp, v as normalizeCdpHttpBaseForJsonEndpoints, w as resolveCdpReachabilityTimeouts, x as stopChromeExtensionRelayServer, z as BrowserTabNotFoundError } from "./chrome-DX0-ldE0.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-IcUkS3f6.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-DKRQ72vp.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-CFhiDgsa.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-j58OQdxE.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-Dx0nEenR.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CiIEhqlX.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-CiIEhqlX.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
