...
import { H as resolveUserPath, Y as truncateUtf16Safe, c as CHANNEL_IDS, i as defaultRuntime, t as createSubsystemLogger } from "./subsystem-DdjWqwPO.js";
import { n as loadConfig, o as writeConfigFile, t as createConfigIO, z as getBlockedNetworkModeReason } from "./config-NpUWC3do.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-BICxZg3K.js";
import { D as runExec, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-COgksURj.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-15XFOczm.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-sfFEhh57.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-CiqvKBRu.js";
import { t as SsrFBlockedError } from "./ssrf-BOBWpv2b.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-B-AjdiIx.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-BKquzTmm.js";
import { A as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, C as stopChromeExtensionRelayServer, D as resolveExistingPathsWithinRoot, E as DEFAULT_UPLOAD_DIR, F as DEFAULT_OPENCLAW_BROWSER_COLOR, I as DEFAULT_OPENCLAW_BROWSER_ENABLED, L as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, M as DEFAULT_AI_SNAPSHOT_MAX_CHARS, N as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, P as DEFAULT_BROWSER_EVALUATE_ENABLED, R as isLoopbackHost, S as ensureChromeExtensionRelayServer, T as DEFAULT_TRACE_DIR, _ as appendCdpPath, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, i as launchOpenClawChrome, j as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, k as resolveWritablePathWithinRoot, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchJson, w as DEFAULT_DOWNLOAD_DIR, y as fetchOk } from "./chrome-BLsJbDXX.js";
import { A as acquireSessionWriteLock, H as resolveAgentMainSessionKey, V as canonicalizeMainSessionAlias } from "./sessions-Bj9-ZDNW.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-BAipUu9z.js";
import { o as normalizeThinkLevel } from "./thinking-C9dOVGlX.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Cq7zCC8o.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-Cq7zCC8o.js")).closePlaywrightBrowserConnection();
		} catch {}
