import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, q as normalizeHyphenSlug, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-Cbd-bzCk.js";
import { Bn as resolveProcessScopedMap, C as parseDurationMs, Dn as resolveSecretRefValues, Hn as isPidAlive, It as containsEnvVarReference, Pr as formatCliCommand, S as getBlockedNetworkModeReason, Vn as getProcessStartTime, i as loadConfig, ir as secretRefKey, l as writeConfigFile, lr as resolveSecretInputRef, nr as parseBooleanValue, or as hasConfiguredSecretInput, t as createConfigIO, ur as CHANNEL_IDS, w as parseByteSize } from "./config-CkXQYijU.js";
import { E as truncateUtf16Safe, M as defaultRuntime, O as createSubsystemLogger, h as normalizeE164, y as resolveUserPath } from "./logger-Blr-bUxJ.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-D6tDENa_.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-BIEkvWNb.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-CcRxN2xk.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-C8XCXp_u.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BwCm3Dbc.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-_gXFGFmo.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-ul1QflQE.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-ul1QflQE.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
