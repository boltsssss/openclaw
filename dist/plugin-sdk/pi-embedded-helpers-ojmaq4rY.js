...
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-CdMwA4fJ.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-B1ctWigy.js";
import { gt as normalizeChatType, r as normalizeChannelId } from "./plugins-dn_4FdQ0.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DwCykKG6.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-DwCykKG6.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
