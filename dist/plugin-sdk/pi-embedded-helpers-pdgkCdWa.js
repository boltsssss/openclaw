import { g as getImageMetadata, m as buildImageResizeSideGrid, o as listDeliverableMessageChannels, p as IMAGE_REDUCE_QUALITY_STEPS, s as normalizeMessageChannel, y as resizeToJpeg } from "./message-channel-C3g3_yJV.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-B7RJlrOt.js";
...
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-CAcZjV6B.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CrhIPXaj.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-CrhIPXaj.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
