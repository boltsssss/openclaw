...
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-DVkFcdre.js";
import { C as createConfigIO, E as loadConfig, Fr as resolveSecretInputRef, G as parseDurationMs, K as parseByteSize, Mr as hasConfiguredSecretInput, W as getBlockedNetworkModeReason, _n as getProcessStartTime, an as containsEnvVarReference, dr as secretRefKey, gn as resolveProcessScopedMap, j as writeConfigFile, kr as formatCliCommand, lr as parseBooleanValue, tr as CHANNEL_IDS, v as resolveSecretRefValues, vn as isPidAlive } from "./model-auth-ofK3pd9f.js";
import { r as normalizeChannelId, y as normalizeChatType } from "./plugins-DTQgTz30.js";
import { t as SsrFBlockedError } from "./ssrf-B--cnODK.js";
import { g as getImageMetadata, m as buildImageResizeSideGrid, o as listDeliverableMessageChannels, p as IMAGE_REDUCE_QUALITY_STEPS, s as normalizeMessageChannel, y as resizeToJpeg } from "./message-channel-kWr_Hy0s.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Chm5u0m0.js";
import { a as saveMediaBuffer, n as ensureMediaDir } from "./store-CneBJJg0.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-CAEEZk4T.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BlVFvWsj.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-BlVFvWsj.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
