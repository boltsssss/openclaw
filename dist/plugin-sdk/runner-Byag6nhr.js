...
import { $ as logVerbose, mt as resolvePreferredOpenClawTmpDir, nt as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-DdjWqwPO.js";
import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-NpUWC3do.js";
import { E as resolveApiKeyForProvider, H as resolveOpenClawAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-BfyNi1_U.js";
import { D as runExec, F as resolveAgentModelPrimaryValue, P as resolveAgentModelFallbackValues } from "./agent-scope-COgksURj.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CiqvKBRu.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DIQalZ6O.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DYXtSTUY.js";
import { t as normalizeChatType } from "./chat-type-CsEnSpHV.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-CCK5B9Ic.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Dwkozf2t.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CFapGP7O.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-D3z1Isdv.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
