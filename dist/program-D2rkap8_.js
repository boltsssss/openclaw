import { Dt as isRich, It as tryParseLogLevel, Ot as theme, Pt as ALLOWED_LOG_LEVELS, St as setVerbose, Z as escapeRegExp, dn as hasFlag, fn as hasHelpOrVersion, on as getCommandPath, pn as hasRootVersionAlias, r as isTruthyEnvValue, un as getVerboseFlag, v as defaultRuntime } from "./entry.js";
import "./auth-profiles-VHiPC1-T.js";
import { n as replaceCliName, r as resolveCliName } from "./command-format-BCo5X8vD.js";
...
import { n as resolveCliChannelOptions } from "./channel-options-DeuKinCn.js";
import { t as getSubCliCommandsWithSubcommands } from "./register.subclis-CX0RmPHw.js";
import { a as registerProgramCommands, r as getCoreCliCommandsWithSubcommands } from "./command-registry-ChcE5GEq.js";
import { r as setProgramContext } from "./program-context-Hoz_7ZCt.js";
import { t as forceFreePort } from "./ports-BJXmttjQ.js";
import { n as formatCliBannerLine, r as hasEmittedCliBanner, t as emitCliBanner } from "./banner-BdrLg_Ij.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-JXs8JQIU.js").then((n) => n.t);
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-CZCd_MNM.js").then((n) => n.n);
