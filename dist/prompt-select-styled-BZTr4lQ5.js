import { $t as resolveStateDir, Jt as resolveIsNixMode, Rt as CONFIG_PATH, Zt as resolveOAuthDir, _n as resolveRequiredHomeDir, dt as sleep, jt as getResolvedLoggerSettings, qt as resolveGatewayPort, r as isTruthyEnvValue, st as resolveUserPath, ut as shortenHomePath, v as defaultRuntime } from "./entry.js";
...
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-DhI_kPU3.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BWKDUbl-.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-TIZD7ZZn.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CZzjuu9e.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-RlRKjsmM.js";
import { B as cleanStaleLockFiles, at as isPrimarySessionTranscriptFileName, c as loadSessionStore, et as resolveMainSessionKey, it as formatSessionArchiveTimestamp } from "./sessions-ByT4CODT.js";
import { n as listChannelPlugins } from "./plugins-DS5tNvig.js";
import { $t as formatRemainingShort, Qt as buildAuthHealthSummary, Zt as DEFAULT_OAUTH_WARN_MS, _ as loadOpenClawPlugins } from "./subagent-registry-l8AgTmVw.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DDT5WL2f.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BapsjycV.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-BEAjYacy.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-BGiHM3g9.js";
import { a as resolveGatewayAuth } from "./auth-D0Wd_Yvg.js";
import { a as formatPortDiagnostics, n as inspectPortUsage } from "./ports-DcKmwJ_3.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-DhVngroR.js";
...
import { r as isWSLEnv, t as isWSL } from "./wsl-CCrOmuzh.js";
import { s as resolveDmAllowState } from "./pi-tools.policy-BwnPwEZA.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-fbWwDD_g.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-wsroINzm.js";
import { t as note$1 } from "./note-DnfO-coK.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DG4owp9O.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-d66J4r0l.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-D3e11yMG.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-D_NtDzbc.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-C7XrxUzM.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-zpQW1REN.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-0uQGaarf.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-BJnLAxRg.js";
import { r as healthCommand } from "./health-Dv7zGKj9.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-DQV5PC6Y.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DY3wLzUh.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-DLAVviXV.js";
import { n as logConfigUpdated } from "./logging-D-v2TQby.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-BrEoEnAn.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-Ce5GdGVt.js";
import { t as formatHealthCheckFailure } from "./health-format-DEUGzke6.js";
import { n as doctorShellCompletion } from "./doctor-completion-B4UWf8GE.js";
