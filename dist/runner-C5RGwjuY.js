import { D as runExec, F as resolveAgentModelPrimaryValue, P as resolveAgentModelFallbackValues } from "./agent-scope-CpuaD-NT.js";
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredOpenClawTmpDir } from "./subsystem-CtFhasYm.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenClawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-Bv3mBCgt.js";
import { t as normalizeChatType } from "./chat-type-DFDuk3FY.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-A6CwyuOb.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-BZiY63-i.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-BF-Rzb1x.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-DAeV-Rxk.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CYFFedEH.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BtTwInIo.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DyB7YZ37.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-BhhzK-Qv.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
