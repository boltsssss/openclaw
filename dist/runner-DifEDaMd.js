import { h as resolveAgentModelPrimaryValue, m as resolveAgentModelFallbackValues } from "./agent-scope-D1xpYq3C.js";
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredOpenClawTmpDir } from "./subsystem-CrwwXlyy.js";
import { _ as runExec } from "./workspace-BM04KBG8.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenClawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-Bws5GHMD.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CKXPj7Vf.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-Bi0kYY78.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-BI4zdGuN.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-4WKMNu0S.js";
import { n as fetchWithTimeout } from "./fetch-timeout-KCB40cfA.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-ClYdSzd0.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-CLPTZAPZ.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-Dt1KyqFm.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
