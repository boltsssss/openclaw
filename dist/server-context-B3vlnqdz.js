...
import { dn as writeConfigFile, en as createConfigIO, rn as loadConfig } from "./model-selection-BoktjT0J.js";
...
import { A as BrowserResourceExhaustedError, B as DEFAULT_AI_SNAPSHOT_MAX_CHARS, C as resolveCdpReachabilityTimeouts, D as BrowserProfileNotFoundError, E as BrowserConflictError, F as InvalidBrowserNavigationUrlError, H as DEFAULT_OPENCLAW_BROWSER_COLOR, I as assertBrowserNavigationAllowed, L as assertBrowserNavigationResultAllowed, M as BrowserTargetAmbiguousError, N as BrowserValidationError, O as BrowserProfileUnavailableError, P as toBrowserErrorResponse, R as withBrowserNavigationPolicy, T as BrowserConfigurationError, U as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as normalizeCdpHttpBaseForJsonEndpoints, a as resolveOpenClawUserDataDir, b as stopChromeExtensionRelayServer, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as fetchOk, i as launchOpenClawChrome, j as BrowserTabNotFoundError, k as BrowserResetUnsupportedError, l as createTargetViaCdp, m as fetchJson, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, x as CDP_JSON_NEW_TIMEOUT_MS, y as ensureChromeExtensionRelayServer, z as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./chrome-Cp7c2wWw.js";
import { i as isLoopbackHost } from "./ws-CQTdazYG.js";
import { a as resolveGatewayAuth } from "./auth-DFkGw0JK.js";
import { n as hasGatewayPasswordEnvCandidate, o as readGatewayTokenEnv, r as hasGatewayTokenEnvCandidate } from "./credentials-Dgqa2Zkk.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-2pLi0rPx.js";
import { r as resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string-BQY6HjIR.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BD_x9Bmk.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-BD_x9Bmk.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
