...
import { i as loadConfig, l as writeConfigFile, r as createConfigIO } from "./config-RlRKjsmM.js";
import { r as isLoopbackHost } from "./net-BEAjYacy.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-BtM0q_Kl.js";
...
import { i as resolveExistingPathsWithinRoot, n as DEFAULT_TRACE_DIR, o as resolveWritablePathWithinRoot, r as DEFAULT_UPLOAD_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-Dm4w47Dx.js";
import { t as SsrFBlockedError } from "./ssrf-BjDQh-0k.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-BnzosEtE.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BEbttllW.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BEbttllW.js")).closePlaywrightBrowserConnection();
		} catch {}
